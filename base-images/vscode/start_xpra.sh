...
XPRA_PASSWORD=123 xpra start-desktop --bind-tcp=0.0.0.0:10000 --html=on --start-child=xterm --exit-with-children=no --daemon=no --notifications=no --bell=no :100 --pulseaudio=no

kasmvncserver -disableBasicAuth
